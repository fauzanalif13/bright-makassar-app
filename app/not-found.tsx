...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 selection:bg-[#15A4FA] selection:text-white">
      <div className="text-center space-y-6 max-w-md">
        {/* Ikon Animasi/Visual */}
        <div className="flex justify-center">
          <div className="bg-[#00529C]/10 p-6 rounded-full">
            <FileQuestion
              className="w-20 h-20 text-[#00529C]"
              strokeWidth={1.5}
            />
          </div>
        </div>
        ...
        {/* Teks 404 */}
        <div>
          <h1 className="text-7xl font-extrabold text-[#00529C] tracking-tight">
            404
          </h1>
